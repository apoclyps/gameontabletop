...
class NightOccurrence(Base):
    ...
    series_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("night_series.id", ondelete="CASCADE"),
        nullable=False,
    )
    ...
    game_vote_deadline: Mapped[datetime | None] = mapped_column(
        DateTime(timezone=True), nullable=True
    )
...
class Rsvp(Base):
    ...
    occurrence_id: Mapped[uuid.UUID] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("night_occurrences.id", ondelete="CASCADE"),
        nullable=False,
    )
    ...
    guest_token_id: Mapped[uuid.UUID | None] = mapped_column(
        UUID(as_uuid=True),
        ForeignKey("guest_tokens.id", ondelete="CASCADE"),
        nullable=True,
    )
    ...
    __table_args__ = (
        UniqueConstraint("occurrence_id", "user_id", name="uq_rsvp_occurrence_user"),
    )
