...
class UserGameCollection(Base):
    ...
    __table_args__ = (UniqueConstraint("user_id", "bgg_game_id", name="uq_user_bgg_game"),)
    ...
    collection_visible_to: Mapped[str] = mapped_column(String(20), nullable=False, default="friends")
